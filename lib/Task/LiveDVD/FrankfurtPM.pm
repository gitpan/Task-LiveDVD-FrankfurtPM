...
Task::LiveDVD::FrankfurtPM - All these modules are installed on LiveDVDs we give away
...
=item * mojolicious::plugin::page::navigator
...
=item * mojolicious::lexicon

parse lexemes from Mojolicious template
...
=item * Padre::Plugin::Mojolicious

Mojolicious support for Padre
...
Use CHI caches within Mojolicious
...
Defend from CSRF attacks centrally.
...
=item * Mojolicious::Command::generate::nifty_app
...
=item * Mojolicious::Plugin::Facebook
...
=item * IO::Async::Loop::Mojo

use IO::Async with Mojolicious
...
Secret access token authentification
...
The webservice component of Rex.IO
...
Client Library for Rex::IO::Server
